...
tuned_parameters = [{'n_estimators': [300,600,900], 'max_depth':[3,4,5], 'max_features': [None,"log2","sqrt","auto"]}]
...
for score in scores:
    ...
    clf = GridSearchCV(GradientBoostingClassifier(warm_start=True, max_features=None, oob_score=True), tuned_parameters, cv=5, scoring='%s_macro' % score, n_jobs=2)
